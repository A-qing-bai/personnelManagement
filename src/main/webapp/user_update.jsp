...
<body>
<form class="layui-form" action="/admin/update" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" placeholder="请输入" autocomplete="off" class="layui-input" value="${a.name}">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    if (${a.status == 1}) {
        ...
        $("option:eq(1)").attr("selected", false);
    } else {
        $("option:eq(0)").attr("selected", false)
